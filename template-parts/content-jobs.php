     ...
     <div class="jobs-form-wrapper">
       <form action="" class="jobs-form">
         ...
         <div class="jobs-form-group">
           ...
           <input type="number" placeholder="Hourly">
           ...
           <select name="Currently Employer Contact" id="" class="jobs-select-wrapper">
             <option value="" disabled selected class="select-text"></option>
             <option value="Yes">Yes</option>
             <option value="No">No</option>
           </select>
         ...
         <div class="jobs-form-group">
           ...
           <select name="Graduation" id="" class="jobs-select-wrapper">
             <option value="" disabled selected class="select-text"></option>
             <option value="Yes">Yes</option>
             <option value="No">No</option>
           </select>
         ...
         <div class="jobs-form-group">
           ...
           <input type="text" class="jobs-school-study">
         </div>
         <!-- Work Section -->
